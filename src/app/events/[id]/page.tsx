    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid lg:grid-cols-5 gap-6">
          {/* Left column: image + description + comments */}
          <div className="lg:col-span-3 space-y-5">
            ...
            <div className="lg:hidden">
              ...
              <h1 className="text-xl font-bold text-gray-950 mt-1">{item.title}</h1>
            </div>
            ...
            <p className="text-xs text-gray-400">Posted by {item.userName || 'Anonymous'} · {new Date(item.createdAt).toLocaleDateString()}</p>

            <CommentSection targetType="event" targetId={item.id} />
          </div>

          {/* Right column: event info + tickets + contact (sticky) */}
          <div className="lg:col-span-2">
            <div className="lg:sticky lg:top-6 space-y-4 lg:border lg:border-gray-200 lg:rounded-lg lg:p-5">
                ...
                <div className="pt-3 border-t border-gray-100 space-y-2">
                  ...
                  {item.contactWhatsapp && (
                    <a href={`https://wa.me/${item.contactWhatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer"
                      className="w-full inline-flex items-center justify-center gap-2 h-10 rounded-md bg-green-500 hover:bg-green-600 text-white text-sm transition-colors">
