    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-6 py-16">
      <div className="w-full max-w-sm animate-fade-in">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-neutral-950 tracking-tight">Create your page</h1>
          <p className="text-neutral-500 text-sm mt-2">Get started in under a minute</p>
        </div>
