        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex items-center justify-between h-14">
            <div className="flex items-center gap-3 min-w-0">
              <h1 className="text-sm font-bold text-slate-900 truncate">{user.businessName}</h1>
              <a
                href={siteUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="hidden sm:flex items-center gap-1 text-xs text-slate-400 hover:text-blue-600 font-mono transition-colors"
              >
