  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Link
          href="/"
          className="flex items-center gap-1 text-sm text-gray-400 hover:text-gray-950 transition-colors mb-6"
        >
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Member since {formatMemberSince(user.createdAt)}</p>
          </div>
        </div>
          ...
          <section className="mb-8">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {businesses.map((b) => (
                <a
                  key={b.id}
                  href={`https://${b.subdomain}.onnepal.com`}
                  target="_blank"
                ...
                >
                  ...
                  <div className="min-w-0">
                    <p className="text-sm font-medium text-gray-950 group-hover:text-gray-700 truncate">
                      {b.businessName}
                    </p>
                    {b.businessCategory && (
                      <p className="text-xs text-gray-400 truncate">{b.businessCategory}</p>
                    )}
                  </div>
                </a>
              ))}
            ...
            <div className="space-y-1">
              {classifieds.map((c) => (
                ...
                >
                  ...
                  {c.price && (
                    <span className="text-sm font-semibold text-gray-950 flex-shrink-0">
                      Rs. {c.price}
                    </span>
                  )}
                </Link>
            ...
            <div className="space-y-1">
              {jobs.map((j) => (
                ...
                >
                  ...
                  {j.salary && (
                    <span className="text-xs text-gray-500 flex-shrink-0">{j.salary}</span>
                  )}
                </Link>
              ))}
            </div>
