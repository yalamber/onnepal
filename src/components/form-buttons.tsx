  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        onClick={onSave}
        disabled={saving}
        className="flex h-9 items-center gap-2 rounded-lg bg-gray-950 px-4 text-sm text-white transition-colors hover:bg-cyan-700 disabled:opacity-50"
      >
...
export function SubmitButton({ submitting, label, disabled, onClick }: SubmitButtonProps) {
  return (
    <button
      ...
      className="flex h-9 w-full items-center justify-center gap-2 rounded-lg bg-gray-950 text-sm text-white transition-colors hover:bg-cyan-700 disabled:opacity-50"
    >
